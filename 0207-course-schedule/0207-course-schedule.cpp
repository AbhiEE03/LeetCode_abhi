...
// private:
//     bool dfs_prerequisite(int course,vector<int> adj[] , vector<int>
...
//             if(!visited[it]){
//                 if(dfs_prerequisite(it, adj, visited, path_visited)) return
//                 true;
...
//         //For CP but not standard C++ but good for memory
//         vector<int> adj[numCourses];
//          Better practice for OAs
//         vector<vector<int>> adj(numCourses); 
//         for(auto &it:prerequisites){
//             int c = it[0];
//             int p = it[1];
...
//         for(int i=0; i<numCourses; i++){
//             if (!visited[i]){
//                 if(dfs_prerequisite(i, adj, visited, path_visited)) return
//                 false;
//             }
//         }
//         return true;
